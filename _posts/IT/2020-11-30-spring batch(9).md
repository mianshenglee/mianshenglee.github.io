...
- [数据批处理神器-Spring Batch(1)简介及使用场景](https://mp.weixin.qq.com/s/mH0kmprpnvk-rvKrYQPF1Q)
- [快速了解组件-spring batch(2)之helloworld](https://mp.weixin.qq.com/s/kCzt2puSE8gdUL49MROrIA)
- [快速使用组件-spring batch(3)读文件数据到数据库](https://mp.weixin.qq.com/s/z2pHjXhMKqxDu-r9PWuOKg)
- [决战数据库-spring batch(4)数据库到数据库](https://mp.weixin.qq.com/s/zA2W_GRKpE7R41VDk05C0g)
- [便捷的数据读写-spring batch(5)结合beetlSql进行数据读写](https://mp.weixin.qq.com/s/BKIhNdyRnOFzkF5eHTCxGA)
- [增量同步-spring batch(6)动态参数绑定与增量同步](https://mp.weixin.qq.com/s/yrpZkBWuHNPibzKvS2g8Jg)
- [调度与监控-spring batch(7)结合xxl-job进行批处理](https://mp.weixin.qq.com/s/Poe8EZxCJgWbd5RkIzU0Eg)
